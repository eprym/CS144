...
Select ItemID
from  Items
where NOofBids>0 and End>'2001-12-20 00:00:01' and (CurrentPrice<BuyPrice or BuyPrice is Null) and CurrentPrice=(
	select max(CurrentPrice) 
	from Items 
	where NOofBids>0 and End>'2001-12-20 00:00:01' and (CurrentPrice<BuyPrice or BuyPrice is Null)
	);
-- and (CurrentPrice<BuyPrice or BuyPrice=Null)
